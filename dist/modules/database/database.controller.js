...
const createObjectDto_1 = require("./createObjectDto");
const updateObjectDto_1 = require("./updateObjectDto");
...
__decorate([
    ...
    __metadata("design:paramtypes", [createObjectDto_1.CreateObjectDTO]),
...
__decorate([
    (0, common_1.Put)(':id/affairs'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, updateObjectDto_1.UpdateObjectDto]),
    __metadata("design:returntype", Promise)
], DatabaseController.prototype, "updateAffairs", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
